# Variables defined here (using the "variable" block) are available to ALL .tf files 
# in this directory because Terraform concatenates everything together.
# We reference them using the "var." syntax (e.g., var.region).
variable "region" {
